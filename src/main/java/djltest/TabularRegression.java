...
// based on: ai.djl.zero.tabular.TabularRegression
public final class TabularRegression {
  private TabularRegression() {
  }

  public static Block createBlock(Performance performance, int featureSize, int labelSize) {
    Block block;
   ...
   */
  public static ZooModel<ListFeatures, Float> train(TabularDataset dataset, Performance performance) throws IOException, TranslateException {
    ...
    Block block = createBlock(performance, featureSize, labelSize);
